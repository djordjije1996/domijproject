...
/**
 * This is the item provider adapter for a {@link domijProject.Gate} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Gate_type_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Gate_type_feature", "_UI_Gate_type"),
				 DomijProjectPackage.Literals.GATE__TYPE,
				 true,
				 false,
				 false,
	...
	protected void addNotationPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Gate_notation_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Gate_notation_feature", "_UI_Gate_type"),
				 DomijProjectPackage.Literals.GATE__NOTATION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
